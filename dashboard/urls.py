...
from . import views
import dashboard.model_views.permission_view as permission_view
...
urlpatterns = [
    ...
    # Group, Permission
    path('permission/groups/', permission_view.PermissionGroupsViewPage.as_view(), name='permission-groups'),
    path('reports/', views.OrderReportView.as_view(), name='order_report'),
    path('reports/', views.OrderReportView.as_view(), name='order_report'),
